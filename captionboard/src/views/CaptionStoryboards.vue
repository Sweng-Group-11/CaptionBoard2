...
<div>
    ...
    <v-expansion-panels accordion>
        ...
        <v-expansion-panel class="blue lighten-5" v-for="(name, nameIndex) in storyboardNames" :key="nameIndex">
            ...
            <v-expansion-panel-content>
                ...
                <div>
                    <p class="font-weight-medium">
                        Company name: {{ companyNames[nameIndex] }}
                    </p>
                </div>
                <div>
                    <p class="font-weight-medium">
                        Description: {{ storyboardDescs[nameIndex] }}
                    </p>
                </div>
          ...
          menu with all the images for the associated storyboard. -->
                <div v-for="(image, imageIndex) in imageRefs[nameIndex]" :key="imageIndex">
                    <v-card class="mx-auto, blue lighten-5" max-width="30%">
                    ...
                    blank box, and also above the text box when you are typing. -->
                                    ...
                                    <v-text-field v-model="caption" :error-messages="captionErrors" :counter="100" label="Enter your caption here" required @input="$v.caption.$touch()" @blur="$v.caption.$touch()"  ></v-text-field>
                              
                                    <!-- Submit Button -->
                                    <v-btn class="mr-4" @click="submit(name, imageIndex + 1)" color="light-green">
                                        submit
                                    </v-btn>

                                    <!-- Clear Button -->
                                    <v-btn @click="clear" color="light red"> clear </v-btn>
                                </form>
                            </div>
                            <v-spacer></v-spacer>
                        </v-card-actions>
